...
<link rel='stylesheet'
	href='js/plugins/grandcarrental-custom-post/css/fontawesome-stars-o.css'
	type='text/css' media='all' />
<link rel='stylesheet'
	href='js/plugins/post-views-counter/css/frontend.css' type='text/css'
	media='all' />
<link rel='stylesheet'
	href='js/plugins/revslider/public/assets/css/settings.css'
	type='text/css' media='all' />
<link rel='stylesheet' href='css/reset.css' type='text/css' media='all' />
<link rel='stylesheet' href='css/wordpress.css' type='text/css'
	media='all' />
...
<link rel='stylesheet' href='css/jqueryui/custom.css' type='text/css'
	media='all' />
<link rel='stylesheet'
	href='js/plugins/mediaelement/mediaelementplayer-legacy.min.css'
	type='text/css' media='all' />
...
<link rel='stylesheet' href='css/menus/leftalignmenu.css'
	type='text/css' media='all' />
...
<body
	class="home page-template-default page page-id-3075 woocommerce-no-js ppb_enable" onload="readTask()">

	<input type="hidden" id="pp_menu_layout" name="pp_menu_layout"
		value="leftalign" />
	<input type="hidden" id="pp_enable_right_click"
		name="pp_enable_right_click" value="0" />
	...
	<input type="hidden" id="tg_smart_fixed_menu"
		name="tg_smart_fixed_menu" value="0" />
	...
	<input type="hidden" id="pp_page_title_img_blur"
		name="pp_page_title_img_blur" value="" />
	<input type="hidden" id="tg_portfolio_filterable_link"
		name="tg_portfolio_filterable_link" value="" />
	<input type="hidden" id="tg_flow_enable_reflection"
		name="tg_flow_enable_reflection" value="" />
	<input type="hidden" id="tg_lightbox_skin" name="tg_lightbox_skin"
		value="metro-black" />
	<input type="hidden" id="tg_lightbox_thumbnails"
		name="tg_lightbox_thumbnails" value="horizontal" />
	<input type="hidden" id="tg_lightbox_thumbnails_display"
		name="tg_lightbox_thumbnails_display" value="1" />
	<input type="hidden" id="tg_lightbox_opacity"
		name="tg_lightbox_opacity" value="0.8" />
	...
	<div class="mobile_menu_wrapper">
		<a id="mobile_menu_close" href="javascript:;" class="button"><span
		...
		<div class="mobile_menu_content">
			 ...
			 <div class="menu-main-menu-container">
                <ul id="mobile_main_menu" class="mobile_main_nav">
                    <li class="menu-item current-menu-item menu-item-has-children"><a href="index.jsp">Home</a>
                    </li>
                    <li class="menu-item  menu-item-has-children"><a href="gallery.jsp">Gallery</a>
                    </li>
							...
							<ul class="sidebar_widget">
								<li id="text-8" class="widget widget_text">
									...
									<div class="textwidget">
										...
										<br /> <span class="ti-alarm-clock"
											style="margin-right: 10px;"></span>Mon - Sat 8.00 - 18.00
									</div>
								</li>
							</ul>
			...
			<div class="social_wrapper">
				<ul>
					...
					<li class="instagram"><a target="_blank" title="Instagram"
						href="http://instagram.com/theplanetd"><i
	...
	<div id="wrapper" class="hasbg transparent">
					...
					<div class="top_contact_info">
						...
						<div>
							<div id="top_contact_number">
								<a href="tel:1.800.456.6743"><span class="ti-mobile"></span>1.800.456.6743</a>
							</div>
						</div>
						<div>
						...
						<div id="logo_normal" class="logo_container">
							<div class="logo_align">
								<a id="custom_logo" class="logo_wrapper hidden"
									href="index.jsp"> <img src="images/logo@2x_white.png"
									alt="" width="175" height="24" />
								</a>
							</div>
						</div>
		...
		<div class="ppb_wrapper  ">
			<div class="one fullwidth ">
				<link
					href="http://fonts.googleapis.com/css?family=Poppins:600%2C700%2C400%2C500"
					...
					<div id="rev_slider_1_1" class="rev_slider fullscreenbanner"
						...
						<ul>
							...
							<li data-index="rs-1" data-transition="fade"
								...
								data-thumb="upload/BMW-Vision-Future-Luxury-Concept-rear-interior-seats-100x50.jpg"
								data-rotate="0" data-saveperformance="off"
								data-mediafilter="xpro2" data-title="Slide" data-param1=""
								data-param2="" data-param3="" data-param4="" data-param5=""
								data-param6="" data-param7="" data-param8="" data-param9=""
								data-param10="" data-description="">
								<!-- MAIN IMAGE --> <img
								src="upload/BMW-Vision-Future-Luxury-Concept-rear-interior-seats.jpg"
								alt=""
								title="BMW-Vision-Future-Luxury-Concept-rear-interior-seats"
								width="1440" height="956" data-bgposition="center center"
								...
								<div class="tp-caption   tp-resizeme" id="slide-1-layer-1"
									...
									data-voffset="10" data-width="['auto']" data-height="['auto']"
									...
									style="z-index: 5; white-space: nowrap; font-size: 60px; line-height: 22px; font-weight: 600; color: rgba(255, 255, 255, 1); letter-spacing:; font-family: Poppins;">
									First Class Service</div> <!-- LAYER NR. 2 -->
								<div class="tp-caption   tp-resizeme" id="slide-1-layer-2"
									...
									data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
									data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
									style="z-index: 6; white-space: nowrap; font-size: 160px; line-height: 22px; font-weight: 700; color: rgba(255, 255, 255, 1); letter-spacing:; font-family: Poppins;">
									Limo</div> <!-- LAYER NR. 3 -->
								<div class="tp-caption   tp-resizeme" id="slide-1-layer-3"
									data-x="center" data-hoffset="" data-y="center"
									data-voffset="60" data-width="['auto']" data-height="['auto']"
									...
									data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
									data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
									style="z-index: 7; white-space: nowrap; font-size: 18px; line-height: 22px; font-weight: 400; color: rgba(201, 201, 201, 1); letter-spacing:; font-family: Poppins;">
									The best luxury limousine & Car Rental in New York</div> <!-- LAYER NR. 4 -->
								<a class="tp-caption rev-btn rev-withicon "
								href="http://themes.themegoods.com/grandtour/demo/tour/tour-3-columns-classic/"
								target="_self" id="slide-1-layer-5" data-x="center"
								data-hoffset="" data-y="center" data-voffset="141"
								...
								style="z-index: 8; white-space: nowrap; font-size: 17px; line-height: 17px; font-weight: 500; color: rgba(255, 255, 255, 1); letter-spacing:; font-family: Poppins; background-color: rgba(4, 219, 192, 1); border-color: rgba(4, 219, 192, 1); border-radius: 30px 30px 30px 30px; outline: none; box-shadow: none; box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; cursor: pointer; text-decoration: none;">View
									Price & Plan<i class="fa-icon-chevron-right"></i>
							</a>
							</li>
							<!-- SLIDE  -->
							<li data-index="rs-2" data-transition="fade"
								...
								data-hideslideonmobile="off" data-easein="default"
								data-easeout="default" data-masterspeed="300"
								data-thumb="upload/shutterstock_74418757-100x50.jpg"
								...
								<!-- MAIN IMAGE --> <img src="upload/shutterstock_74418757.jpg"
								alt="" title="shutterstock_74418757" width="1440" height="1248"
								data-bgposition="center center" data-bgfit="cover"
								data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
								<!-- LAYERS --> <!-- LAYER NR. 5 -->
								<div class="tp-caption   tp-resizeme" id="slide-2-layer-1"
									data-x="60" data-y="center" data-voffset=""
									...
									data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
									data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
									style="z-index: 5; white-space: nowrap; font-size: 46px; line-height: 48px; font-weight: 600; color: rgba(255, 255, 255, 1); letter-spacing:; font-family: Poppins;">
									Experience First Class <br />Limousine Service
								</div> <!-- LAYER NR. 6 -->
								<div class="tp-caption   tp-resizeme" id="slide-2-layer-3"
									data-x="60" data-y="center" data-voffset="80"
									...
									data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
									data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
									style="z-index: 6; white-space: nowrap; font-size: 18px; line-height: 22px; font-weight: 400; color: rgba(255, 255, 255, 1); letter-spacing:; font-family: Poppins;">
									We proudly provide first class limousine service <br />to our
									customers for over 10 years
								</div> <!-- LAYER NR. 7 --> <a
								class="tp-caption rev-btn rev-withicon "
								href="http://themes.themegoods.com/grandtour/demo/tour/niko-trip/"
								target="_self" id="slide-2-layer-5" data-x="60" data-y="center"
								data-voffset="170" data-width="['auto']" data-height="['auto']"
								...
								style="z-index: 7; white-space: nowrap; font-size: 17px; line-height: 17px; font-weight: 500; color: rgba(255, 255, 255, 1); letter-spacing:; font-family: Poppins; background-color: rgba(4, 219, 192, 1); border-color: rgba(4, 219, 192, 1); border-radius: 30px 30px 30px 30px; outline: none; box-shadow: none; box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; cursor: pointer; text-decoration: none;">View
									Plan & Price<i class="fa-icon-chevron-right"></i>
							</a>
							</li>
						</ul>
			...
			<div class="one withsmallpadding ppb_header "
				style="text-align: center; padding: 0px 0 0px 0; margin-top: 60px; margin-bottom: 60px;">
				<div class="standard_wrapper">
					<div class="page_content_wrapper">
						<div class="inner">
							<div style="margin: auto; width: 100%">
								<h2 class="ppb_title" style="">Our Fleet</h2>
								<div class="page_tagline" style="">We know the difference
									is in the details and that's why our car rental services</div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="ppb_car_grid one nopadding " style="margin-bottom: 30px;">
				<div
					class="page_content_wrapper page_main_content sidebar_content full_width fixed_column">
					<div class="standard_wrapper">
						<div id="1572257382750659109"
							class="portfolio_filter_wrapper gallery grid three_cols"
							data-columns="3">
							<div class="element grid classic3_cols animated1">
                                <div class="one_third gallery3 grid static filterable portfolio_type themeborder" style="background-image:url(upload/15C1119_043-1280x849-700x466.jpg);">
                                    <a class="car_image" href="mobil_mercedessl.jsp"></a>
                                        ...
                                        <div class="car_attribute_wrapper">
                                            ...
                                            <div class="car_attribute_wrapper_icon">
                                                ...
                                                <div class="one_fourth">
                                                    ...
                                                    <div class="car_attribute_content">Mnl
                                                    </div>
                                                </div>
                                            </div>
                                            <br class="clear" />
                            ...
                            <div class="element grid classic3_cols animated2">
                                <div class="one_third gallery3 grid static filterable portfolio_type themeborder" style="background-image:url(upload/Audi-A4-Avant-1-700x466.jpg);">
                                    <a class="car_image" href="mobil_audia4.jsp"></a>
                                    <div class="portfolio_info_wrapper">
                                        <div class="car_attribute_wrapper">
                                            <h4>Audi A4</h4>
                                            <div class="car_attribute_wrapper_icon">
                            ...
                            <div class="element grid classic3_cols animated3">
                                <div class="one_third gallery3 grid static filterable portfolio_type themeborder" style="background-image:url(upload/2016-bmw-7-series-exterior-images-1900x1200-07-700x466.jpg);">
                                    <a class="car_image" href="mobil_bmw7.jsp"></a>
                                    <div class="portfolio_info_wrapper">
                                        <div class="car_attribute_wrapper">
                                            <h4>BMW 7 Series</h4>
                                            <div class="car_attribute_wrapper_icon">
                            ...
                            <div class="element grid classic3_cols animated4">
                                <div class="one_third gallery3 grid static filterable portfolio_type themeborder" style="background-image:url(upload/Porsche-Boxster-Wheels-8-700x466.jpg);">
                                    <a class="car_image" href="mobil_porscheboxster.jsp"></a>
                                    <div class="portfolio_info_wrapper">
                                        <div class="car_attribute_wrapper">
                            ...
                            <div class="element grid classic3_cols animated5">
                                <div class="one_third gallery3 grid static filterable portfolio_type themeborder" style="background-image:url(upload/2016-Lexus-RX-350-BM-01-700x466.jpg);">
                                    <a class="car_image" href="mobil_lexus.jsp"></a>
                                    <div class="portfolio_info_wrapper">
                                        <div class="car_attribute_wrapper">
                                            <h4>Lexus RX</h4>
                                            <div class="car_attribute_wrapper_icon">
                            ...
                            <div class="element grid classic3_cols animated6">
                                <div class="one_third gallery3 grid static filterable portfolio_type themeborder" style="background-image:url(upload/2016-Mercedes-Benz-GLE-2-700x466.jpg);">
                                    <a class="car_image" href="mobil_mercedesbengle.jsp"></a>
                                    <div class="portfolio_info_wrapper">
                                        <div class="car_attribute_wrapper">
			...
			<div class="one withsmallpadding ppb_header_youtube withbg parallax"
				...
				<div class="standard_wrapper">
					<div class="page_content_wrapper">
						<div class="inner">
							<div style="margin: auto; width: 100%">
								<h2 class="ppb_title" style="color: #ffffff;">Our Fleet,
									Your Fleet</h2>
								<div class="page_tagline" style="color: #ffffff;">
									We know the difference is in the details and that's why our car
									rental services, in the tourism <br /> and business industry,
									stand out for their quality and good taste, to offer you an
									unique experience
								</div>
								<div class="ppb_header_content">
									<p>
										<span style="font-size: 32px;">Call Now (54)-344-4533-4</span>
									</p>
									<p>
					...
					<div class="page_content_wrapper">
						<div class="inner">
							<div style="margin: auto; width: 100%">
								...
								<div class="page_tagline" style="color: #ffffff;">Explore
									our first class limousine &amp; car rental services</div>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="inner">
							<div style="margin: auto; width: 100%">
								...
								<div class="one_third " style="">
									...
									<p>Grand Car Rental have a lot Varianty of Car Brands and Car Type</p>
								</div>
								<div class="one_third " style="">
									<span class="ti-face-smile"
										style="display: block; font-size: 50px; margin-bottom: 20px;"> </span>
									<h4 style="color: #fff;">Best Rate Guarantee</h4>
									<p>Grand Car Rental is best rate guarantee for car rental in the world</p>
								</div>
								<div class="one_third last " style="">
									...
									<p>Grand Car Rental have awesome customer support and fast respond for serve to customer.</p>
								</div>
								<p>
									<br class="clear" />
								</p>
					...
					<div class="page_content_wrapper">
						<div class="inner">
							<div style="margin: auto; width: 100%">
								...
								<div class="page_tagline" style="">Car rental, limousine,
									and car hire. All in one service.</div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="one withsmallpadding ppb_team_column">
				<div
					class="page_content_wrapper page_main_content sidebar_content full_width fixed_column photoframe">
					<div class="standard_wrapper">
						<div id="15722574382014118329"
							class="portfolio_filter_wrapper gallery five_cols"
							data-columns="2">
							<div
								class="element grid photoframe fixed_columns classic5_cols animated1">
								<div class="one_fifth gallery5 classic filterable"
									style="margin-left: 28%;">
									<div class="post_img">
										<img class="team_pic"
											src="upload/pexels-photo-62365-500x500.jpeg" alt="" />
										<ul class="social_wrapper team">
											<li><a title="Dani Lee on Twitter" target="_blank"
												class="tooltip" href="https://twitter.com/#"><i
													class="fa fa-twitter"></i></a></li>
											<li><a title="Dani Lee on Facebook" target="_blank"
												class="tooltip" href="https://facebook.com/#"><i
													class="fa fa-facebook"></i></a></li>
											<li><a title="Dani Lee on Google+" target="_blank"
												class="tooltip" href="#"><i class="fa fa-google-plus"></i></a></li>
											<li><a title="Dani Lee on Linkedin" target="_blank"
												class="tooltip" href="#"><i class="fa fa-linkedin"></i></a></li>
										</ul>
									</div>
									<div class="portfolio_info_wrapper center">
										<h4>M.Dani Setiawan</h4>
										<div class="page_tagline">Manusia ½ Dewa</div>
									</div>
								</div>
							</div>
							<div
								class="element grid photoframe fixed_columns classic5_cols animated2">
								<div class="one_fifth gallery5 classic filterable"
									style="margin-left: 4%;">
									<div class="post_img">
										<img class="team_pic"
											src="upload/pexels-photo-57759-500x500.jpeg" alt="" />
										<ul class="social_wrapper team">
											<li><a title="John Bennett on Twitter" target="_blank"
												class="tooltip" href="https://twitter.com/#"><i
													class="fa fa-twitter"></i></a></li>
											<li><a title="John Bennett on Facebook" target="_blank"
												class="tooltip" href="https://facebook.com/#"><i
													class="fa fa-facebook"></i></a></li>
											<li><a title="John Bennett on Google+" target="_blank"
												class="tooltip" href="#"><i class="fa fa-google-plus"></i></a></li>
											<li><a title="John Bennett on Linkedin" target="_blank"
												class="tooltip" href="#"><i class="fa fa-linkedin"></i></a></li>
										</ul>
									</div>
									<div class="portfolio_info_wrapper center">
										<h4>Zain Haddad</h4>
										<div class="page_tagline">Gamers</div>
									</div>
								</div>
							</div>
						</div>
		...
		<div id="footer" class=" ppb_wrapper">
			...
			<ul class="sidebar_widget three">
				<li id="text-2" class="widget widget_text">
					...
					<div class="textwidget">
						<p>Getting dressed up and traveling with good friends makes
							for a shared, unforgettable experience.</p>
						<p>
							<img src="images/logo@2x_white.png" alt="" width="175"
								height="24">
						</p>
					</div>
				</li>
				<li id="text-3" class="widget widget_text">
					...
					<div class="textwidget">
						...
						<p>
							<span class="ti-location-pin" style="margin-right: 10px;"></span>184
							Main Street East Perl Habour 8007
						</p>
						<p>
							<span class="ti-alarm-clock" style="margin-right: 10px;"></span>Mon
							- Sat 8.00 - 18.00 Sunday CLOSED
						</p>
				...
				<li id="mc4wp_form_widget-5" class="widget widget_mc4wp_form_widget">
					...
					<form id="mc4wp-form-1" class="mc4wp-form mc4wp-form-27"
						method="post" data-id="27" data-name="Newsletter">
						<div class="mc4wp-form-fields">
							Don't miss a thing! Sign up to receive daily deals <input
								type="email" id="emailsubcriber" name="EMAIL"
								placeholder="Your Email Address" required /> <br /> <input
								type="submit" value="Subscribe" onclick="save_subcriber();" />
						</div>
	...
	<script type='text/javascript'
		src='js/plugins/grandcarrental-custom-post/js/jquery.barrating.js'></script>
	<script
		src='js/plugins/revslider/public/assets/js/jquery.themepunch.tools.min.js'></script>
	<script
		src='js/plugins/revslider/public/assets/js/jquery.themepunch.revolution.min.js'></script>
	<script
		src="js/plugins/revslider/public/assets/js/extensions/revolution.extension.slideanims.min.js"></script>
	<script
		src="js/plugins/revslider/public/assets/js/extensions/revolution.extension.layeranimation.min.js"></script>
	<script
		src="js/plugins/revslider/public/assets/js/extensions/revolution.extension.kenburn.min.js"></script>
	<script
		src="js/plugins/revslider/public/assets/js/extensions/revolution.extension.navigation.min.js"></script>
	<script
		src="js/plugins/revslider/public/assets/js/extensions/revolution.extension.parallax.min.js"></script>
	<script
		src="js/plugins/revslider/public/assets/js/extensions/revolution.extension.actions.min.js"></script>
	<script
		src="js/plugins/revslider/public/assets/js/extensions/revolution.extension.video.min.js"></script>
	<script type="text/javascript">
	...
	<script type='text/javascript'
		src='js/plugins/jquery.requestAnimationFrame.js'></script>
	...
	<script type='text/javascript'
		src='js/plugins/jquery.tooltipster.min.js'></script>
	<script type='text/javascript' src='js/plugins/jarallax.js'></script>
	<script type='text/javascript'
		src='js/plugins/jquery.sticky-kit.min.js'></script>
   ...
   <script>
		...
		function save_subcriber() {
			var emailsubcriber = document.getElementById('emailsubcriber').value;
			var uid = firebase.database().ref().child('subcriber').push().key;
			var data = {
				emailsubcriber : emailsubcriber
			}
			var updates = {};
			updates['/subcriber/' + uid] = data;
			firebase.database().ref().update(updates);
			alert('Thankyou for subcriber :)');
			reload_page();
		}
