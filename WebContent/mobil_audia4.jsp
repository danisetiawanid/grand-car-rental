...
<body
	class="home page-template-default page page-id-3075 woocommerce-no-js ppb_enable">
		...
		<div class="mobile_menu_content">
			...
			<div class="menu-main-menu-container">
                <ul id="mobile_main_menu" class="mobile_main_nav">
                    <li class="menu-item menu-item-has-children"><a href="index.jsp">Home</a>
                    </li>
                    <li class="menu-item current-menu-item menu-item-has-children"><a href="gallery.jsp">Gallery</a>
                    </li>
	...
	<div id="wrapper" class="hasbg transparent">
		...
		<div id="page_caption" class="hasbg  withtopbar "
			style="background-image: url(upload/Audi-A4-Avant-1.jpg);">
				...
				<div class="standard_wrapper">
					<div class="single_car_header_price">
						<span id="single_car_price"><span
							class="single_car_currency">$</span><span
							class="single_car_price">252</span> <span
							id="single_car_price_per_unit_change"
							class="single_car_price_per_unit"> </span> 
						...
						<div class="car_attribute_wrapper">
							<div class="car_attribute_rating">
								<div class="br-theme-fontawesome-stars-o">
									<div class="br-widget">
										<a href="javascript:;" class="br-selected"></a> <a
											href="javascript:;" class="br-selected"></a> <a
											href="javascript:;" class="br-selected"></a> <a
											href="javascript:;"></a> <a href="javascript:;"></a>
									</div>
								</div>
								<div class="car_attribute_rating_count">4&nbsp; reviews</div>
							</div>
						</div>
						<div class="single_car_attribute_wrapper themeborder">
							<div class="one_fourth">
								<div class="car_attribute_icon ti-user"></div>
								<div class="car_attribute_content">2&nbsp;Passengers</div>
							</div>

							<div class="one_fourth">
								<div class="car_attribute_icon ti-briefcase"></div>
								<div class="car_attribute_content">1&nbsp;Luggages</div>
							</div>

							<div class="one_fourth">
								<div class="car_attribute_icon ti-panel"></div>
								<div class="car_attribute_content">Auto</div>
							</div>

							<div class="one_fourth last">
								<div class="car_attribute_icon ti-car"></div>
								<div class="car_attribute_content">2&nbsp; Doors</div>
							</div>
						</div>
						<br class="clear" />
						<div class="single_car_content">
							<h4 class="p1">Refueling</h4>
							<p class="p2">Meh synth Schlitz, tempor duis single-origin
								coffee ea next level ethnic fingerstache fanny pack nostrud.
								Photo booth anim 8-bit hella, PBR 3 wolf moon beard Helvetica.
								Salvia esse nihil, flexitarian Truffaut synth art party deep v
								chillwave. Seitan High Life reprehenderit consectetur cupidatat
								kogi. Et leggings fanny pack, elit bespoke vinyl art party
								Pitchfork selfies master cleanse.</p>
							<h4 class="p1">Car Wash</h4>
							<p class="p2">Craft beer elit seitan exercitation, photo
								...
								jean vinegar stumptown yr pop-up artisan sunt. Craft beer elit
								seitan exercitation, photo booth</p>
							<h4 class="p1">No Smoking</h4>
							<p class="p2">See-through delicate embroidered organza blue
								lining luxury acetate-mix stretch pleat detailing. Leather
								detail shoulder contrastic colour contour stunning silhouette
								...
								and sleek. Polished finish elegant court shoe work duty stretchy
					...
					<div class="sidebar_wrapper">
						...
						<div class="sidebar">
							...
							<div class="content">
								...
								<div class="single_car_header_price">
									<span id="single_car_price_scroll"><span
										class="single_car_currency">$</span><span
										class="single_car_price">252</span></span> <span
										id="single_car_price_per_unit_change_scroll"
										class="single_car_price_per_unit"> <span
										id="single_car_unit_scroll">Per Day</span> <span
										class="ti-angle-down"></span>

										<ul id="price_per_unit_select_scroll">
											<li class="icon arrow"></li>
											<li class="active"><a class="active" href="javascript:;"
												data-filter="car_price_day"
												data-price="&lt;span class=&quot;single_car_currency&quot;&gt;$&lt;/span&gt;&lt;span class=&quot;single_car_price&quot;&gt;84&lt;/span&gt;">Per
													Day</a></li>
											<li><a class="active" href="javascript:;"
												data-filter="car_price_hour"
												data-price="&lt;span class=&quot;single_car_currency&quot;&gt;$&lt;/span&gt;&lt;span class=&quot;single_car_price&quot;&gt;10&lt;/span&gt;">Per
													Hour</a></li>
											<li><a class="active" href="javascript:;"
												data-filter="car_price_airport"
								...
								<div
									class="single_car_booking_wrapper themeborder book_instantly">
									<div class="wpcf7" lang="en-US" dir="ltr">
										<div class="screen-reader-response"></div>
										<form class="wpcf7-form">

											<p>
												<input type="hidden" value="Audi A4" size="40" id="carname" />
												<input type="hidden" value="252" size="40" id="carprice" />
												<label> Full Name <br /> <span
													class="wpcf7-form-control-wrap your-name"><input
														type="text" id="fullname" value="" size="40"
														class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required"
														aria-required="true" aria-invalid="false"
														placeholder="Muhamad Dani Setiawan" required /></span>
												</label>
											</p>
											<p>
												<label> Email Address <br /> <span
													class="wpcf7-form-control-wrap your-email"><input
														type="email" id="email" value="" size="40"
														class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email"
														aria-required="true" aria-invalid="false"
														placeholder="dani@danisetiawan.com" required /></span>
												</label>
											</p>
											<p>
												<label> Phone Number <br /> <span
													class="wpcf7-form-control-wrap your-tel"><input
														type="tel" id="phonenumber" value="" size="40"
											...
											<p>
												<label> Pickup Address <br /> <span
													class="wpcf7-form-control-wrap pickup-address"><input
														type="text" id="pickupaddress" value="" size="40"
														class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required"
														aria-required="true" aria-invalid="false"
														placeholder="34 Mainfield Road" required /></span>
												</label>
											</p>
											<p>
												<label> Pickup Date <br /> <span
													class="wpcf7-form-control-wrap"><input type="date"
														id="date1"
														class="wpcf7-form-control wpcf7-date wpcf7-validates-as-required wpcf7-validates-as-date" /></span>
												</label>
											</p>

											<p>
												<label> Drop Off Address <br /> <span
													class="wpcf7-form-control-wrap dropoff-address"><input
														type="text" id="dropaddress" value="" size="40"
														class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required"
														aria-required="true" aria-invalid="false"
														placeholder="Heatrow Airport" /></span>
												</label>
											</p>
											<p>
												<label> Drop Off Date <br /> <span
													class="wpcf7-form-control-wrap"><input type="date"
														id="date2"
														class="wpcf7-form-control wpcf7-date wpcf7-validates-as-required wpcf7-validates-as-date" /></span>
												</label>
											...
											<input type="button" value="Total" class="button"
												onclick="sumdani();">
											</button>
											...
											<p>
												<label> Total <br /> <span
													class="wpcf7-form-control-wrap dropoff-date"><input
														type="text" id="total"
														class="wpcf7-form-control wpcf7-date wpcf7-validates-as-required wpcf7-validates-as-date"
														aria-required="true" aria-invalid="false" readonly /></span>
												</label>
											</p>

											<input type="button" value="Start Booking"
												style="background-color: #04DBC0 !important; color: #ffffff !important;"
												...
												<div class="modal-content">
																		...
																		<div class="card-body">
																				...
																				<div class="col-sm-12">
																					<div class="form-group">
																						<label for="name">Name</label> <input
																							class="form-control" id="cardname" type="text"
																					...
																					<div class="form-group">
																						...
																						<div class="input-group">
																							<input class="form-control" type="text"
																								...
																								autocomplete="email" id="cardnumber">
																			...
																			<div class="row">
																				<div class="form-group col-sm-4">
																					<label for="ccmonth">Month</label> <select
																						class="form-control" id="ccmonth">
																						<option>1</option>
																						<option>2</option>
																						<option>3</option>
																						<option>4</option>
																				...
																				<div class="form-group col-sm-4">
																					<label for="ccyear">Year</label> <select
																						class="form-control" id="ccyear">
																						<option>2014</option>
																						<option>2015</option>
																						<option>2016</option>
																						<option>2017</option>
																				...
																				<div class="col-sm-4">
																					<div class="form-group">
																						<label for="cvv">CVV/CVC</label> <input
																							class="form-control" id="cvv" type="text"
																							placeholder="123"
													...
													<div class="modal-footer">
														...
														<button type="button" class="btn"
															style="background-color: #04DBC0 !important; color: #ffffff !important;"
															onclick="save_user();">Booking Now</button>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="single_car_users_online_wrapper themeborder">
									...
									<div class="single_car_users_online_content">
										<strong>231</strong> traveler(s) are considering our cars
										right now!
									</div>
								</div>
	...
	<script type='text/javascript' src='js/plugins/jquery.cookie.js'></script>
	<script type='text/javascript' src='js/plugins/dani.js'></script>
	<script type='text/javascript'>
		/* <![CDATA[ */
	...
	<script>
		jQuery(function() {
			jQuery(
					"#driving_rating, #interior_rating, #space_rating, #overall_rating")
					.barrating({
